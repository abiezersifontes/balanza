...
<div id="app">
    ...
    <footer>
        <div id="c">
            <div class="container">
                <p>
                    <b>Sistema de Balanza</b>
                    <strong>Copyright &copy; 2015 <a href="http://codeplus.com.ve">Codeplus.com.ve</a>.
                    <br/>
                    Sistema para la balanza de Cabelum, soporte a traves de asifontes@cabelum.com.ve
                </p>
...
<script src="{{ mix('/js/select2.js') }}" type="text/javascript"></script>
<script src="{{ mix('/plugins/bootstrap-datepicker.js') }}"></script>
<script src="{{ mix('/plugins/bootstrap-datepicker.es.js') }}" type="text/javascript"></script>
